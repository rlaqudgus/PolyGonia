...
namespace Manager.DialogueScripts
{
    public class DialoguePoint : NPC, ITalkable
    {
        ...
        private void OnEnable() => DialogueManager.Instance.OnDialogueEnded += DialogueEnded;

        private void OnDisable() => DialogueManager.Instance.OnDialogueEnded -= DialogueEnded;
